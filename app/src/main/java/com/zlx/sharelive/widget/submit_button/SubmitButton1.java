package com.zlx.sharelive.widget.submit_button;
 ...
 * @description:
 */
public class SubmitButton1 extends View {
    ...
    public SubmitButton1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SubmitButton1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAnimSetRect2Round() {
        if (animRect2Round == null) {
            LogUtil.e("startAnimSetRect2Round:" + height);
