...
import com.zlx.sharelive.widget.euclid.EuclidActivity;
import com.zlx.sharelive.widget.euclid.EuclidListAdapter;
 ...
 * @description:
 */
public class MainAc extends EuclidActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Oh hi!", Toast.LENGTH_SHORT).show();
            }
        });
    }
